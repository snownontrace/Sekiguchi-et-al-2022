...
inputFolder = "/Volumes/ShaoheGtech2/SMG-epi-CRISPR-Cas9-CasRx-perturbation-assays-2019-2020/190523-CRISPR-KO-SMG-IF/190523-LV-230-anti-Hsp47-647-anti-Col4-red/";
...
Dialog.addString("Channel 3 name", "NLSmSL_Col4");
Dialog.addString("Channel 4 name", "HSP47");
...
//	saturation = 0.2; idC4_8bit = to8bitSatu( idC4, typePrefix + "-" + c4name, saturation, outputFolder, outputPrefix );
	c4min = 0; c4max = 4095; idC4_8bit = to8bitMinMax( idC4, typePrefix + "-" + c4name, c4min, c4max, outputFolder, outputPrefix );
