...
//	idC4 = getChannel(id, 4);
	...
	saturation = 0.1; idC1_8bit = to8bitSatuPhase( idC1, typePrefix + "-" + c1name, saturation, outputFolder, outputPrefix );
...
//	c2min = 0; c2max = 2000; idC2_8bit = to8bitMinMax( idC2, typePrefix + "-" + c2name, c2min, c2max, outputFolder, outputPrefix );
...
//	c4min = 0; c4max = 4000; idC4_8bit = to8bitMinMax( idC4, typePrefix + "-" + c4name, c4min, c4max, outputFolder, outputPrefix );

//	mergeBGMY( idC1_8bit, c1name, idC2_8bit, c2name, idC3_8bit, c3name, idC4_8bit, c4name, outputFolder, outputPrefix );
//	mergeGC( idC1_8bit, c1name, idC2_8bit, c2name, outputFolder, outputPrefix );
//	mergeGM( idC1_8bit, c1name, idC2_8bit, c2name, outputFolder, outputPrefix );
