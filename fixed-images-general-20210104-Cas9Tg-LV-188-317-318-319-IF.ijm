...
inputFolder = "/Volumes/ShaoheGtech2/SMG-epi-CRISPR-Cas9-CasRx-perturbation-assays-2019-2020/20210104-Cas9Tg-LV-188-317-318-319-IF/";
...
//	c2min = 0; c2max = 800; idC2_8bit = to8bitMinMax( idC2, typePrefix + "-" + c2name, c2min, c2max, outputFolder, outputPrefix );
	saturation = 3.0; idC3_8bit = to8bitSatu( idC3, typePrefix + "-" + c3name, saturation, outputFolder, outputPrefix );
