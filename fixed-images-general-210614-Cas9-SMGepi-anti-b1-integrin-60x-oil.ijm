...
inputFolder = "/Volumes/ShaoheGtech2/SMG-epi-CRISPR-Cas9-CasRx-perturbation-assays-2019-2020/210614-Cas9-SMGepi-anti-b1-integrin-60x-oil/210614-Cas9-SMGepi-LV-188-anti-beta1-integrin-60x/";
//inputFolder = "/Volumes/ShaoheGtech2/SMG-epi-CRISPR-Cas9-CasRx-perturbation-assays-2019-2020/210614-Cas9-SMGepi-anti-b1-integrin-60x-oil/210614-Cas9-SMGepi-LV-401-anti-beta1-integrin-60x/";
...
Dialog.addString("Channel 4 name", "ITGB1");
...
//	c1min = 70; c1max = 7000; idC1_8bit = to8bitMinMax( idC1, typePrefix + "-" + c1name, c1min, c1max, outputFolder, outputPrefix );
	saturation = 0.05; idC2_8bit = to8bitSatu( idC2, typePrefix + "-" + c2name, saturation, outputFolder, outputPrefix );
//	c2min = 0; c2max = 800; idC2_8bit = to8bitMinMax( idC2, typePrefix + "-" + c2name, c2min, c2max, outputFolder, outputPrefix );
	saturation = 2.0; idC3_8bit = to8bitSatu( idC3, typePrefix + "-" + c3name, saturation, outputFolder, outputPrefix );
...
//	saturation = 0.2; idC4_8bit = to8bitSatu( idC4, typePrefix + "-" + c4name, saturation, outputFolder, outputPrefix );
	c4min = 20; c4max = 500; idC4_8bit = to8bitMinMax( idC4, typePrefix + "-" + c4name, c4min, c4max, outputFolder, outputPrefix );

	mergeGM( idC2_8bit, c2name, idC3_8bit, c3name, outputFolder, outputPrefix );
