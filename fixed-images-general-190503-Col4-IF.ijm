...
Dialog.addString("Channel 2 name", "NLSmSL");
...
Dialog.addNumber("Which slice?", 20)
...
//	c1min = 70; c1max = 7000; idC1_8bit = to8bitMinMax( idC1, typePrefix + "-" + c1name, c1min, c1max, outputFolder, outputPrefix );
	saturation = 0.1; gamma_value = 0.5; idC2_8bit = to8bitSatuGamma( idC2, typePrefix + "-" + c2name, saturation, gamma_value, outputFolder, outputPrefix );
...
//	saturation = 0.1; gamma_value = 0.5; idC3_8bit = to8bitSatuGamma( idC3, typePrefix + "-" + c3name, saturation, gamma_value, outputFolder, outputPrefix );
	c3min = 20; c3max = 1600; idC3_8bit = to8bitMinMax( idC3, typePrefix + "-" + c3name, c3min, c3max, outputFolder, outputPrefix );
...
//	c4min = 20; c4max = 1200; idC4_8bit = to8bitMinMax( idC4, typePrefix + "-" + c4name, c4min, c4max, outputFolder, outputPrefix );
	...
	mergeGM( idC3_8bit, c3name, idC2_8bit, c2name, outputFolder, outputPrefix );
